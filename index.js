...
/* Task 5: Create a function called get20s() that takes data as an argument and returns an array with names of artists who were born the 19th century (1800-1900) */
function yearSort(art, id) {
  var temp = []
  for (let i = 0; i < art.length; i++) {
    if (art[i].years.includes("18"))
      temp.push(art[i])

    if (art[i].years.includes("17"))
      temp.pop(art[i])
  }
  return temp
}

console.log(yearSort(artists))
...
console.log(addArtist('75', 'Troy', '1991-2221', 'classical', 'American', 'Very good painter with many famous works of art.'));
